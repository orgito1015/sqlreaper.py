...
# The banner and highlighted output use box-drawing / emoji characters that
# aren't representable in legacy codepages (e.g. Windows cp1252, or any
# redirected/piped stream without an explicit encoding) — force UTF-8 so
# printing never crashes the tool mid-scan.
